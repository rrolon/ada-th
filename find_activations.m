function pp = find_activations(dict, data_b, data_d, data_eh, data_ih,...
    data_jh, MP_coeff, set, method)
    ...
    if strcmp(method, 'adath') || strcmp(method, 'nnet') || ...
            strcmp(method, 'adann') || strcmp(method, 'adaknn')
